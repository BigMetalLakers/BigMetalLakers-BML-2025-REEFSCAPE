...
//     // Create Motors
//     public final Spark lifter = new Spark(CoralConstants.kLifterPWMPort);
//     public final Spark joint = new Spark(CoralConstants.kJointPWMPort);
//     public final Spark intake = new Spark(CoralConstants.kCoralIntakePWMPort);

//     // Create Encoders
//     public final Encoder lifterEncoder = new Encoder(CoralConstants.kLifterEncoderPortA, CoralConstants.kLifterEncoderPortB);
//     public final Encoder jointEncoder = new Encoder(CoralConstants.kJointEncoderPortA, CoralConstants.kJointEncoderPortB);
...
//       new SparkMax(CoralSubsystemConstants.kIntakeMotorCanId, MotorType.kBrushless);
  private SparkMax intakeMotor =
      new SparkMax(CoralSubsystemConstants.kIntakeMotorCanId, MotorType.kBrushed);
//   private Spark intakeMotor = 
//       new Spark(CoralSubsystemConstants.kIntakeMotorCanId);
  ...
  public Command rotate(double motorSpeed) {
    return this.startEnd(
      () -> armMotor.set(motorSpeed), () -> armMotor.set(0));
        // armMotor.set(motorSpeed > 1 ? 1 : (motorSpeed < -1 ? -1 : motorSpeed));
